...
void boid_pos_update(struct boid *, float, float);
void boid_update(struct boid_system *);
void boid_update_neighbors(struct boid_system *);
void draw_boid(struct boid *);
void draw_boid_system(struct boid_system *);